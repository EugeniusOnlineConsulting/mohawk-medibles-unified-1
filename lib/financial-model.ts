...
export function generateGrowthStrategies(metrics: FinancialMetrics): GrowthStrategy[] {
    ...
    if (metrics.averageOrderValue < targetAOV) {
        ...
        strategies.push({
            ...
            description: "Add 'Complete Your Order' upsell widget at checkout for carts above $120. Offer bundle discounts (buy 3+ items, get 10% off). Display 'Free shipping at $150+' progress bar in cart.",
