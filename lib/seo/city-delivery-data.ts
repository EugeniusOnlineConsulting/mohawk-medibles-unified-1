...
export function getCityFaqs(cityName: string, provinceName: string, legalAge: number, deliveryTime: string) {
    return [
        ...
        { question: `What cannabis products can I order in ${cityName}?`, answer: `Mohawk Medibles offers over 344 premium cannabis products available for delivery to ${cityName}, including lab-tested flower, edibles, concentrates, hash, vapes, and CBD products. All products meet our Empire Standard\u2122 for quality.` },
