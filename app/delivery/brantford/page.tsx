/**
 * /delivery/brantford — Local SEO Landing Page
 */
...
const area = SERVICE_AREAS.find((a) => a.slug === "brantford")!;

export const metadata: Metadata = localLandingPageMetadata(area);

export default function BrantfordDeliveryPage() {
    return (
        <>
            <script
            ...
            <DeliveryLanding
                ...
                nearbyAreas={["Hamilton", "Caledonia", "Six Nations", "Hagersville"]}
            />
        </>
    );
}
