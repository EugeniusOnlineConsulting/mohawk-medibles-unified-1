/**
 * /delivery/toronto — Local SEO Landing Page
 */
...
const area = SERVICE_AREAS.find((a) => a.slug === "toronto")!;

export const metadata: Metadata = localLandingPageMetadata(area);

export default function TorontoDeliveryPage() {
    return (
        <>
            <script
            ...
            <DeliveryLanding
                ...
                nearbyAreas={["Hamilton", "Brantford"]}
            />
        </>
    );
}
