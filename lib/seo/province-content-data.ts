...
export const PROVINCE_CONTENT: Record<string, ProvinceContent> = {
	ontario: {
		...
		introContent:
			"Ontario is Mohawk Medibles' home province — our dispensary operates from Six Nations of the Grand River territory in the heart of Southern Ontario. With over 20 cities served across the province, from Toronto and Ottawa to Thunder Bay and Sudbury, Ontario customers enjoy the fastest delivery times in our network. Whether you are in the GTA, Durham Region, Niagara, or Northern Ontario, our premium cannabis ships via Canada Post Xpresspost with full tracking.",
		whyChooseUs:
			"As an Indigenous-owned dispensary operating under inherent Haudenosaunee rights on Six Nations territory, Mohawk Medibles offers Ontario customers something unique: Empire Standard™ quality with lab-tested, terpene-profiled products that meet the highest standards in the Canadian cannabis market. Our proximity means most Ontario orders arrive within 1-2 business days.",
	...
	alberta: {
		...
		whyChooseUs:
			"Alberta's competitive cannabis market means consumers have plenty of choices — and they keep choosing Mohawk Medibles for our Empire Standard™ quality and transparent lab testing. Our premium flower, concentrates, and edibles are competitively priced with free shipping on orders over $199.",
	...
	manitoba: {
		...
		whyChooseUs:
			"Manitoba customers value reliability and quality — especially when home growing is not an option. Mohawk Medibles fills that gap with Empire Standard™ products, lab-tested and terpene-profiled for consistency. Free shipping on orders over $199 makes premium cannabis accessible across the prairies.",
	...
	saskatchewan: {
		...
		whyChooseUs:
			"In Saskatchewan's competitive private market, Mohawk Medibles stands out with Empire Standard™ quality at fair prices. Our lab-tested products, transparent terpene profiles, and free shipping over $199 make us a preferred choice for Saskatchewan cannabis consumers who want premium quality delivered to their door.",
	...
	"newfoundland-and-labrador": {
		...
		whyChooseUs:
			"Newfoundland's remote location means limited cannabis options and higher prices at local retailers. Mohawk Medibles offers NL customers access to a wide selection of premium, lab-tested products at competitive prices, with free shipping on orders over $199 to offset the distance.",
	...
	"northwest-territories": {
		...
		whyChooseUs:
			"Northern living comes with unique challenges — limited product selection and premium pricing are two of them. Mohawk Medibles bridges the gap with competitive pricing, free shipping over $199, and a curated selection of lab-tested products perfect for long northern evenings under the aurora borealis.",
	...
	nunavut: {
		...
		whyChooseUs:
			"For Nunavut residents, online cannabis delivery is not just convenient — it is often the only option. Mohawk Medibles provides Nunavummiut with access to premium, lab-tested products at fair southern prices, with free shipping on orders over $199 to help offset the challenges of northern delivery.",
	...
	yukon: {
		...
		introContent:
			"The Yukon, land of the midnight sun and the Klondike Gold Rush, has a small but passionate cannabis community. Mohawk Medibles delivers to Whitehorse and Dawson City, serving the territory's two main population centres. Despite the distance from our Six Nations base, Yukon customers enjoy reliable Canada Post Xpresspost delivery with full tracking.",
		whyChooseUs:
			"Yukon's limited retail options mean northern cannabis consumers pay premium prices for basic selection. Mohawk Medibles changes that equation — Empire Standard™ quality at competitive prices, delivered to the Wilderness City and beyond. Free shipping over $199 makes premium cannabis accessible even in Canada's far north.",
