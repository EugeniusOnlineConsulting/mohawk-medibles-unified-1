...
const FAQ_ITEMS = [
    ...
    { question: "Is there a minimum order amount?", answer: "No minimum order required! However, orders over $150 CAD qualify for FREE shipping Canada-wide." },
    ...
    { question: "What product categories do you carry?", answer: "We carry 363+ products across Flower, Edibles, Concentrates, Vapes, Hash, CBD, Mushrooms, and Accessories. Our catalogue is updated regularly with new arrivals." },
...
export const metadata: Metadata = {
    title: "Frequently Asked Questions — Ordering, Shipping & Products",
    description:
